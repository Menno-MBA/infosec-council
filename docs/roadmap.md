...
pressure, that inference is tagged `[ASSUMED — verify: <owner>]`, collected in an assumptions
register, and blocked by a synthesis gate from hardening into the record as fact. Ships with a
