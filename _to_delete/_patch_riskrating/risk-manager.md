...
**Output contract:**
1. Top risks from this decision: scenario plus likelihood plus impact plus rating. Where an impact is already observed or confirmed (encryption present, outage under way, data exposed), its likelihood is Likely, not Possible: the risk has materialized, so do not under-rate it.
