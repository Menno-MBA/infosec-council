...
| CER / Wet weerbaarheid kritieke entiteiten (Wwke) | **No, unless formally designated** (row checked 2026-07-31 against rijksoverheid.nl / rdi.nl and EUR-Lex) | Applies only to organisations a ministry **designates** as a critical entity: roughly 500 in NL, none of them SMEs by size alone. In force 15 Aug 2026 with the Cbw; designations follow as soon as possible after. Flip to Yes on receiving a designation, not on reading the sector list. Two couplings matter even at No: a designated entity is automatically a NIS2 **essential** entity regardless of size (NIS2 Art. 3(1)(f)), and a supplier to one will be asked to evidence resilience without being in scope itself. |
...
| CER / Wwke *(row checked 2026-07-31)* | Dir. (EU) 2022/2557, adopted the same day as NIS2 as a deliberate pair: NIS2 covers **cyber** resilience, CER covers **physical** resilience (sabotage, terrorism, natural hazards) for largely the same sectors. Transposition was due 17 Oct 2024; NL is late, via the Wet weerbaarheid kritieke entiteiten, **in force 15 Aug 2026** [VERIFY]. Scope is by ministerial **designation**, not size or sector alone (~500 entities in NL). Art. 15 notification: initial within 24h of awareness, detailed report within 1 month. Not authoritative for cyber duties, which stay with NIS2/Cbw. | Regulation (directive) | Physical resilience and continuity duties for designated critical entities | CISO, COMP, RISK |
...
| `cer_initial_notification` | Initial notification of a disruptive incident | Formally designated as a critical entity under CER/Wwke **and** an incident that significantly disrupts, or could disrupt, an essential service | Compliance | CISO (notifier) + Legal & Comms | **24h from awareness** | Sector competent authority (NL: RDI or ILT by sector) | CER Art.15 / Wwke |
| `cer_detailed_report` | Detailed report | as above | Compliance | CISO (notifier) + Legal & Comms | **1 month** after the initial notification | as above | CER Art.15 / Wwke |
| `cer_cross_border` | Flag a cross-border incident for onward notification | A `cer_initial_notification` fired **and** the incident has, or could have, significant impact on essential services in six or more member states | Compliance | CISO (notifier) | With the initial notification | Competent authority (which notifies the Commission) | CER Art.15(3) |
...
**CER/Wwke is designation-gated, and its clock is not NIS2's.** The two rows fire only for an entity a ministry has formally **designated**; a sector match is not scope, so for almost every SME both return NOT TRIGGERED by designation and that is the correct entry in the ledger. Where they do fire, do not reuse the NIS2 rhythm: CER is **24h then a detailed report at 1 month**, with no 72h stage in between, and the recipient is the sector's competent authority rather than the CSIRT. Two exceptions worth knowing before ruling the rows out: a designated entity is a NIS2 essential entity automatically, so the NIS2 rows may fire even where size would not have put it in scope; and in the Netherlands **digital infrastructure is carved out of the Wwke's risk-assessment, duty-of-care and notification duties** (Wwke Art. 23) because the Cbw already covers them, so a designated digital-infrastructure entity reports under the Cbw, not here. [VERIFY]
